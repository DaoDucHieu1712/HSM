...
namespace HSM.Application.Specifications
{
    public static class SpecificationBuilderExtensions
    {
            ...
            string operatorSearch = FilterOperator.CONTAINS)
        {
            ...
            {
                FilterOperator.STARTS_WITH => $"{keyword.ToLower()}%",
                FilterOperator.ENDS_WITH => $"%{keyword.ToLower()}",
            ...
            string filterOperator)
        {
            ...
            return filterOperator switch
            {
                ...
                FilterOperator.STARTS_WITH => Expression.Call(memberExpression, "StartsWith", null, constantExpression),
                FilterOperator.ENDS_WITH => Expression.Call(memberExpression, "EndsWith", null, constantExpression),
        ...
        public static dynamic? ChangeType(object? value, Type conversion)
        {
            ...
            if (t == typeof(DateTimeOffset))
            {
                return value switch
                {
                    string stringValue => DateTimeOffset.Parse(stringValue),
